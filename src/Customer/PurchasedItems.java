...
public PurchasedItems(String name,Integer amount,String type,Double price){
	...
	this.cost=price;
	this.itemType=type;
	this.dayBought= new GregorianCalendar(); //set the date bought to current day
}
...
public boolean equals (Object obj) {
	...
	if (cost == null) {
		...
		return false;
	if (dayBought == null) {
		if (other.dayBought != null)
			return false;
	} else if (!dayBought.equals(other.dayBought))
		return false;
		*/
	if (itemName == null) {
